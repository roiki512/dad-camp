  ...
  days: [
    ...
    /* ───── MONDAY — standard · reading + salt dough + library ───── */
    {
      ...
      blocks: [
        ...
        { time: "13:15-14:00", slot: "quiet", title: "Quiet Board Game (Sorry / Memory)", activityId: "quiet-boardgame-quiet", note: "library books come this afternoon — solo reading starts tomorrow" },
    ...
    /* ───── TUESDAY — gym day · math + bracelets ───── */
    {
      ...
      blocks: [
        ...
        { time: "12:30-13:15", slot: "lunch", title: "Lunch", fixed: true },
        { time: "13:15-14:00", slot: "quiet", title: "Cozy Solo Reading (fresh library books!)", activityId: "quiet-soloreading", note: "books picked up at Monday's library trip" },
